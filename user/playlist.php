  ...
  <body> 
	...
	<section id = "section1">
		...
		<div style="display:flex; ">
			...
			<button style="cursor: pointer;background-color:#666699; color: white; float:right;border: none; border-radius: 25px;" type="submit">Search</button><br/>
		</div>	
		</form>
		...
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:#cc99ff;">
			...
			$sql = "SELECT id,song_name, artist_name, album from favorites";
			...
			<div class="row" style="padding:5px;"> 
				...
				<div class="col-md-3"> 
				<a href="play_fav.php?id=<?php echo $row["id"]; ?>">
				...
				<a href="deletePlaylist.php?id=<?php echo $row["id"]; ?>"> Delete</a>
				</button> 
				</a>
